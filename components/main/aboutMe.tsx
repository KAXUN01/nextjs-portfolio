  ...
  return (
    ...
    >
      ...
      <div className="md:w-1/2 md:mr-8">
        <h2 className="text-[40px] font-bold font-cinzel text-white mb-4 text-center">
          {" "}
          &lt; ABOUT ME /&gt;
        </h2>
        <p className="text-gray-50 mb-4 text-2xl font-cinzel text-white text-justify md:text-xl text-center">
